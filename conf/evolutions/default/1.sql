...
alter table record add constraint fk_record_relative_user_id foreign key (relative_user_id) references relative_user (id) on delete restrict on update restrict;
create index ix_record_relative_user_id on record (relative_user_id);
...
alter table if exists record drop constraint if exists fk_record_relative_user_id;
drop index if exists ix_record_relative_user_id;
